...
> **Current state (2026-08-24):** the gate is **PASSED — 6/6 recorded**. M5 is unblocked.
> Code side verified: build clean, 213/213 tests, `--smoke` 17/17.
>
...
>
> **Ticked 2026-08-24 from the owner's reported run** (all four languages, JA on both MS-IME
> and ATOK; items 4 and 5 reported separately the same day). Results here are only ever
> transcribed from what the owner reports; **an AI session must not decide them.**
...
**Result: 6/6 PASS — GATE PASSED (owner run, 2026-08-24).** All four languages, JA on both
MS-IME and ATOK: insertion, composition, newline, candidate-window tracking, and
first/middle/last-line input all green, including the zh-TW and KO cases that previously
showed nothing at all.

**Item 4 detail.** Enter during composition commits the IME composition and does **not** fire
PigComic's confirm — the D-32 guard holds, which is what M5's confirm loop depends on.
Shift+Enter during composition: MS Pinyin (zh-CN) exits composition immediately, which the
owner verified behaves identically in Notepad — **IME-defined behaviour, not a PigComic
defect; do not "fix" it.** The other IMEs ignore Shift+Enter while composing.

**Item 5 detail.** Shift+Alt, Alt+`~` and the zh-CN Shift toggle all switch IME state correctly
while the editor is focused.

**M5 is unblocked.** The next task is PLAN M5.1.
